...
export const Hero = () => {
    return (
        <div className="sm:flex sm:justify-center flex flex-col  ">
            <div className="sm:w-full rounded-2xl bg-gradient-to-r from-[#96E9FB] to-[#ABECD6] sm:flex sm:flex-row sm:justify-stretch sm:items-center sm:pl-24 sm:gap-12 sm:z-1000 sm:relative sm:h-159 sm:flex-wrap flex flex-col justify-between h-[60rem] pt-20 mx-2">
