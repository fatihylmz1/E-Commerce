...
import img1 from "../photos/single-product-1-cover-2.jpg";
import img2 from "../photos/shopping-card-2.png";
import img3 from "../photos/shop-card/card-cover-5.jpg";
        ...
        <div className="flex flex-col gap-2">
            <section className="relative ">
                ...
                >
                    {arr.map((image, i) => (
                        <div
                            key={i}
                            className={`shrink-0  md:w-[600px] md:h-[500px] ${activeId == i ? "active" : ""
                                }`}
                        >
            ...
            >
                {arr.map((image, i) => (
                    <div
                        key={i}
                        className={`opacity-50 shrink-0 md:w-32 ${activeId == i ? "active" : ""
                            }`}
