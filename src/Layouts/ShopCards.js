...
export const ShopCards = () => {
    return (
        <div className="sm:flex sm:flex-row  sm:pl-52 sm:pr-44 sm:py-20 sm:h-180 sm:justify-between flex-wrap flex flex-col pl-9 pr-9">

            <div className="bg-shopping-card-1 sm:w-1/2 sm:h-auto bg-no-repeat  bg-scroll z-1000 flex flex-col justify-end items-start w-full h-[35rem] sm:bg-left-top bg-center">
                <div className="z-2000 sm:w-96 max-w-96 h-56 bg-explore-blue opacity-85 mb-5 flex flex-col justify-center pl-16 pr-36 w-full ">
